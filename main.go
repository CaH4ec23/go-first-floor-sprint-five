...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Weight + ((math.Pow(w.meanSpeed(), 2)/MInKm)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
